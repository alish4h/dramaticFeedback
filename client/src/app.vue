    ...
    <f7-login-screen id="register-screen">
      <f7-view>
        <f7-page login-screen>
          ...
          <f7-list form>
            <f7-list-item>
              <f7-label>Enter Email</f7-label>
              <f7-input name="email" placeholder="email" type="email"></f7-input>
              <f7-label>Confirm Username</f7-label>
              <f7-input name="Email" placeholder="Email" type="email"></f7-input>
            </f7-list-item>
            <f7-list-item>
              <f7-label>Enter Password</f7-label>
              <f7-input name="password" type="password" placeholder="Password"></f7-input>
          ...
          <f7-list>
            <f7-list-button title="Register" login-screen-close></f7-list-button>
            <f7-block-footer>
              <p>Click Register to close Register Screen</p>
            </f7-block-footer>
          </f7-list>
        </f7-page>
      </f7-view>
